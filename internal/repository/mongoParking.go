...
func (rep *Mongo) GetAllParkingLots(e context.Context) ([]*model.ParkingLot, error) {
...
func (rep *Mongo) GetParkingLotByNum(e context.Context, num int) (*model.ParkingLot, error) {
